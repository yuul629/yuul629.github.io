...
export const site = {
  ...
  author: {
     ...
     * HTML is supported.
     */
    subtitle: `Student Msc. Mechanical Engineering
      &nbsp;·&nbsp;
      Junior Product Specialist at 
      <a href="https://www.xpeng-center.nl/vestigingen/xpeng-center-utrecht">Xpeng Center</a>,
      Utrecht`,
  ...
  socials: {
    ...
    linkedin_username: 'yulisa-blok-13419b352',
    github_username: 'yuul629',
    ...
    cv_pdf: '/assets/pdf/CV_Yulisa_blok.pdf',
