...
<div class="caption">
  Slide left/right to compare. Use <code>slot="first"</code> and <code>slot="second"</code> on the
  Figure components.
</div>
...
<img-comparison-slider
  tabindex="0"
  style="--divider-width: 3px; --divider-color: hsl(210 80% 55%);"
>
  <figure slot="first" style="margin:0; position:relative;">
    <img
      src={withBase('/assets/img/9.jpg')}
      class="img-fluid"
      alt="Light theme"
      style="display:block; width:100%;"
    />
    <figcaption style="position:absolute; bottom:8px; left:8px; background:rgba(0,0,0,.55); color:#fff; padding:2px 8px; border-radius:4px; font-size:.8rem;">
      Before
    </figcaption>
  </figure>
  <figure slot="second" style="margin:0; position:relative;">
    <img
      src={withBase('/assets/img/10.jpg')}
      class="img-fluid"
      alt="Dark theme"
      style="display:block; width:100%;"
    />
    <figcaption style="position:absolute; bottom:8px; right:8px; background:rgba(0,0,0,.55); color:#fff; padding:2px 8px; border-radius:4px; font-size:.8rem;">
      After
    </figcaption>
  </figure>
</img-comparison-slider>
