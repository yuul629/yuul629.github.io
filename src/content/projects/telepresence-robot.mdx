...
<h2 id = "engineering-decisions">Engineering desicions</h2>
...
<h2 id="realization">Realization of the prototype</h2>
...
<a
  href="/assets/pdf/Yulisa_Blok-GP.pdf"
  target="_blank"
